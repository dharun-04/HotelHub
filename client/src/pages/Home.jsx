...
const Home = () => {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        const res = await fetch("https://hotelhub-tv7k.onrender.com/api/listing/get?offer=true&limit=4");
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch(url+"/api/listing/get?type=sale&limit=4");
        const data = await res.json();
    ...
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto ">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          HotelHub is the best place to find your next perfect place to
          live.
          <br />
